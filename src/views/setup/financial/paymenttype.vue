<template>
    <div class="animated fadeIn">
         <b-row> <!-- แถว -->
             <b-card no-body class="w-100 card-accent-info">  <!-- กรอบทีมองไม่เก็น -->
                <pageheader :title="$t('dic.paymenttype')"></pageheader><!-- หัวเรื่อง -->

                <div class="navbar navbar-light bg-default"><!-- กรอบ ค้นหา -->
                     <form class="form-search form-inline col-sm-12 col-md-11" @submit.prevent="Search">
                        ...
                        >  <!-- ชื่อหัวข้อ ค้นหา -->
                            <b-form-input
                             ...
                             trim
                             v-model="txtSearch"> <!-- input box  มี ชื่อ search แสดงรางๆๆๆ-->
